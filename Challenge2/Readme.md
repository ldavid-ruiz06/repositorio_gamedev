...
5) Se duplica y se acomoda el otro ojo
...
6) Se termina de crear el prefab de Kirby
...
1) Se importa el prefab y se agrega una esfera, la cual se modifica para hacer la lampara
...
2) Se agregan esferas para las manos
...
3) Se agrega una pocion de curar
...
4) Se agrega una esfera para crear un pie
...
5) Se acomoda el pie, y se duplica para crear otra
...
Usando herramientas y procesos similares se crean las otras variaciones
